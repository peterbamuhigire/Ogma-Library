...
Release tests pass 318 total tests: Core 232, UI 71, Architecture 15.
...
| `dotnet test OgmaLibrary.sln --configuration Release --no-build` | Passed: Core 232, UI 71, Architecture 15 |
