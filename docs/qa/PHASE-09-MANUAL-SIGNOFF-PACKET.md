...
Release tests pass 320 total tests: Core 232, UI 73, Architecture 15.
...
| `dotnet test OgmaLibrary.sln --configuration Release --no-build` | Passed: Core 232, UI 73, Architecture 15 |
