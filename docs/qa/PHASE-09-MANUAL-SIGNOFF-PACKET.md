...
Release tests pass 319 total tests: Core 232, UI 72, Architecture 15.
...
| `dotnet test OgmaLibrary.sln --configuration Release --no-build` | Passed: Core 232, UI 72, Architecture 15 |
