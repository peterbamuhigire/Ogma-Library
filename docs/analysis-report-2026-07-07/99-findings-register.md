...
| F-ARCH-001 | Architecture | High | Resolved - Phase 02: ADR-0015 makes the v2.0 remediation baseline binding and architecture tests enforce composition-root/runtime boundaries; remaining beta controls stay tracked under security/release findings. | `docs/adrs/0015-documentation-baseline-v2.md`; `tests/OgmaLibrary.Tests.Architecture/ArchitectureTests.cs:87` | Release-critical controls must be implemented before beta. | Architecture is not beta-ready. |
...
| F-DOC-001 | Docs | High | Resolved - Phase 02: ADR-0014 and ADR-0015 are present in `docs/adrs` and accepted. | `docs/adrs/0014-ef-core-10-on-net10-runtime.md`; `docs/adrs/0015-documentation-baseline-v2.md` | Proposed ADRs must be resolved. | Binding decisions remain open. |
