...
| 16 | IN PROGRESS | Asset manifests, precedence, validation, custom covers, stale GC, bounded lazy variants, allowlisted bounded provider-image client | Resolver integration/embedded flow, API authorization, UI, scale budget |
