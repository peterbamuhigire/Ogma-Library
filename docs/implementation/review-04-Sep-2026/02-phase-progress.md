...
| 20 | IN PROGRESS | Curation foundations, desktop status/rating/favourite detail controls, bounded tag mutation | Tag UI, collections, file/relink, provenance, E2E |
