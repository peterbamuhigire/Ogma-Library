...
| 25 | IN PROGRESS | Provenance, local-only policy, dimensions including payload metadata, stale detection/tombstones, localized stale-count/rebuild-status UI | ANN, scale, cost, representative corpus, reference confirmation |
