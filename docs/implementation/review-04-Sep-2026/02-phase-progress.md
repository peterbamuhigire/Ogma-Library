...
| 25 | IN PROGRESS | Provenance, local-only policy, dimensions including payload metadata, stale detection/tombstones, localized stale-count/rebuild-status UI, bounded-memory 50k scan | ANN/relevance quality, cost, representative corpus, reference confirmation |
