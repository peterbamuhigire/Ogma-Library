...
| 10 | IN PROGRESS | Input broker, password transport, sandbox copy/output bounds, process ceilings | True OS sandbox/escape evidence and independent security approval |
