...
opaque blob integrity/size checks, remote-IP audit minimization, and redacted
secrets/tokens. No critical or high finding is recorded in the reviewed scan;
