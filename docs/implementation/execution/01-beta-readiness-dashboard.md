...
| 17 | Leases, retries, dead-lettering, resource groups, safe queued cancellation, cancelled metrics, diagnostics, and Windows/macOS hosted process recovery | Cooperative active cancellation, full-app crash/activity-centre, physical reference-machine process, and soak evidence open | [phase-17](phase-17-progress.md) |
