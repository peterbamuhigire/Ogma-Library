...
| 17 | Leases, retries, distinct pause/dead-letter states, resource groups, safe queued cancellation, cooperative OCR controls, fail-safe unsupported-active pause semantics, metrics/redacted diagnostics, Activity Centre controls/export, and Windows/macOS hosted process recovery | Cooperative control for other active handlers, full-app crash, physical reference-machine process, and soak evidence open | [phase-17](phase-17-progress.md) |
