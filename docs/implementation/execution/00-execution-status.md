...
| 16 | Cover, Thumbnail and Spine Assets | IN PROGRESS | Manifest, precedence, projection, output validation, stale-asset GC, and bounded lazy variants delivered; provider/embedded acquisition, UI, and scale open |
