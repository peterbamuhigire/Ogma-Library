...
| 26 | Semantic and Hybrid Retrieval | IN PROGRESS | RRF, hybrid fallback, structured prefilters, dimension filtering, metric contract and durable local evaluation runs delivered; corpus, ANN, diversity and scale open |
