...
| 28 | Advisor Intent, Candidates and Reranking | IN PROGRESS | Intent, candidate ranking, fallbacks and durable privacy-preserving stage-diagnostics traces delivered; editable UI, reference resolution and benchmarks open |
| 29 | Grounded Explanations and Answer Mode | IN PROGRESS | Source-labeled local evidence, versioned payload evidence assembly, provenance validation and untrusted-payload boundary delivered; citation UI/consent/benchmarks open |
