...
| 20 | Book Detail, Organisation and Reading State | IN PROGRESS | Curation foundations, desktop status/rating/favourite controls, bounded bulk tag mutation, rendered detail tag editor, and sidebar collection create/delete controls delivered; smart-shelf queries, file/relink, provenance, accessibility and E2E open |
