...
| 22 | Structured and Fuzzy Catalogue Search | IN PROGRESS | Structured field queries, scoped fuzzy fallback, debounced type-ahead, bounded 50-result candidate materialization and local 50k p95 evidence delivered; facets/paging/highlighting/full-text fallback open |
