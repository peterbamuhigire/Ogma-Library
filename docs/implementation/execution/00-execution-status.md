...
| 19 | Production 2D Catalogue | IN PROGRESS | Cover control, asset loading, functional directory view, server-side read-model paging and local 50k page performance evidence delivered; UI paging, parity/filter/sort/badges/auth/reference confirmation open |
| 20 | Book Detail, Organisation and Reading State | IN PROGRESS | Curation foundations and desktop status/rating/favourite detail controls delivered; collections, file/relink, provenance and E2E open |
...
| 29 | Grounded Explanations and Answer Mode | IN PROGRESS | Source-labeled local evidence, desktop local-answer/citation display, durable privacy-safe answer traces, versioned payload evidence assembly, provenance validation and untrusted-payload boundary delivered; citation navigation/consent/benchmarks open |
| 30 | Advisor UX and Quality Evaluation | IN PROGRESS | Routes, interpreted-intent UI, local answer/citation display, consented feedback UI, offline evaluation foundations, durable evaluation runs, erasable advisor-history export/delete, and fail-closed metric thresholds delivered; live evaluation, accessibility and retrieval freeze open |
...
| 32 | Virtual Bookshelf Visuals and Interaction | IN PROGRESS | Meshes, local assets, interaction, bounded labels, local syntax/bridge verification, source/build provenance, distant-book LOD, reduced-motion camera policy, and FocusBook bridge command delivered; texture-atlas scale, search/advisor UI wiring/reference confirmation, and physical evidence open |
