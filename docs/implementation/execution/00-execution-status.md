...
| 18 | Ogma Design System and Application Shell | IN PROGRESS | Design controls, focus, typography, detail-panel/catalogue-shell/Student Smart Search/Advisor/startup/detail-format/AI accessibility/3D fallback localization, persisted theme/density, command-palette execution, and static route inventory delivered; application-wide copy coverage, contrast, and physical accessibility open |
