...
| 35 | Classroom Client, Offline and Sync | IN PROGRESS | Tamper-evident, host-scoped cache with exact content-length verification, quota eviction, versioned ZIP export, all-Host erasure, localized cache controls, bounded sync, and deterministic offline/reconnect session renewal delivered; physical credential/pairing/network interruption/offline UX/isolation/load evidence open |
