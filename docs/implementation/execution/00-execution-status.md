...
| 32 | Virtual Bookshelf Visuals and Interaction | IN PROGRESS | Meshes, local assets, interaction, bounded labels, local syntax/bridge verification, and source/build provenance delivered; atlas/LOD, search/advisor focus, reduced-motion camera, and physical evidence open |
...
| 35 | Classroom Client, Offline and Sync | IN PROGRESS | Tamper-evident cache including exact content-length verification, host scoping, bounded sync and local 104-test evidence delivered; credential/pairing/reconnect/offline UX/isolation/load evidence open |
...
| 38 | Performance, Reliability, Packaging and Beta | IN PROGRESS | Release descriptors, cryptographic detached-signature verification, candidate packaging, integrity gates, local migration compatibility and script verification delivered; signed installers, clean install, performance, recovery and rollback open |
