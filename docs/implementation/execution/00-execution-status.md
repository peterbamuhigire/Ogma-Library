...
| 35 | Classroom Client, Offline and Sync | IN PROGRESS | Tamper-evident, host-scoped cache with exact content-length verification, quota eviction, versioned ZIP export, bounded sync and local 108-test evidence delivered; credential/pairing/reconnect/offline UX/isolation/load evidence open |
