...
| 38 | Performance, Reliability, Packaging and Beta | IN PROGRESS | Release descriptors, cryptographic detached-signature verification, candidate packaging, integrity gates, local migration compatibility, script verification and actionlint workflow validation delivered; CI format gate, signed installers, clean install, performance, recovery and rollback open |
