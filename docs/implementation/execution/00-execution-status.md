...
| 16 | Cover, Thumbnail and Spine Assets | IN PROGRESS | Manifest, precedence, projection, output validation, stale-asset GC, bounded lazy variants, and allowlisted bounded provider-image client delivered; resolver integration/embedded flow, UI, and scale open |
