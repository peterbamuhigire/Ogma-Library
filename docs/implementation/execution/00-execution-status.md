...
| 26 | Semantic and Hybrid Retrieval | IN PROGRESS | RRF, hybrid fallback, structured prefilters, dimension filtering, metric contract, durable local evaluation runs, author-diversity policy and local 50k latency evidence delivered; representative corpus/ANN/memory/reference confirmation open |
