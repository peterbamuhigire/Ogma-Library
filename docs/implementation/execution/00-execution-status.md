...
| 18 | Ogma Design System and Application Shell | IN PROGRESS | Design controls, focus, typography, application-wide natural-language copy extraction, detail-panel/catalogue-shell/Student Smart Search/Advisor/startup/detail-format/AI accessibility/3D/directory fallback and Host-sharing copy localization, persisted theme/density, command-palette execution, and static route inventory delivered; contrast and physical accessibility open |
