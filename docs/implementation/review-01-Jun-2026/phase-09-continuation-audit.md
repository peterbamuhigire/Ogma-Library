...
French localization cleanup passes, text-selection service traceability, and
Choose Library Folder missing-`BookFiles` scan repair coverage on 2026-06-01.
...
The continuation pass found eleven locally actionable mismatches and fixed
them:
