...
coverage, reader file-locator missing-`BookFiles` retry repair, plus follow-up
evidence-count, test-name, filter-token, and task-exit documentation sweeps on
2026-06-01.
...
pass beyond the reader file-locator hardening recorded above.
