# Phase 01 Verification: Restore and Build Stabilization
...
3. Targeted tests for affected modules under `Directory.Build.props; OgmaLibrary.sln; src/*/*.csproj; tests/*/*.csproj; package lock/audit artifacts`. Choose the narrowest matching project/filter first and record the exact command.
...
Findings that may be marked resolved after this phase: **F-BLD-001, F-TEST-001**.
