# Phase 19 Verification: Signing and Notarization
...
3. Targeted tests for affected modules under `build; scripts; .github/workflows; docs/deployment; docs/security`. Choose the narrowest matching project/filter first and record the exact command.
...
Findings that may be marked resolved after this phase: **F-REL-002**.
