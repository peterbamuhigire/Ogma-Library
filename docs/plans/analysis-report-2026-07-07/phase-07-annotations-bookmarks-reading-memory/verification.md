# Phase 07 Verification: Database Migration Integrity
...
3. Targeted tests for affected modules under `src/OgmaLibrary.Infrastructure/Catalogue; src/OgmaLibrary.Infrastructure/Persistence/Migrations; tests/OgmaLibrary.Tests/Catalogue`. Choose the narrowest matching project/filter first and record the exact command.
...
Findings that may be marked resolved after this phase: **F-DATA-001, F-DATA-002, F-DATA-003**.
