# Phase 11 Verification: Split View Reader Workflow
...
3. Targeted tests for affected modules under `src/OgmaLibrary.App/ViewModels/Reader; src/OgmaLibrary.App/Views/Reader; src/OgmaLibrary.Reader; tests/OgmaLibrary.Tests.Ui`. Choose the narrowest matching project/filter first and record the exact command.
...
Findings that may be marked resolved after this phase: **F-ARCH-003, F-FUNC-003**.
