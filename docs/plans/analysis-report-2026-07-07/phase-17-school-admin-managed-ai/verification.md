# Phase 17 Verification: Observability, Telemetry, and SLOs
...
3. Targeted tests for affected modules under `src/OgmaLibrary.Application/Diagnostics; src/OgmaLibrary.Infrastructure/Diagnostics; src/OgmaLibrary.App/Views/Settings; docs/operations`. Choose the narrowest matching project/filter first and record the exact command.
...
Findings that may be marked resolved after this phase: **F-PERF-003, F-REL-004**.
