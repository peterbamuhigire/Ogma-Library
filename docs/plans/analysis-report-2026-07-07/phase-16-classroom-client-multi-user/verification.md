# Phase 16 Verification: Reference-Hardware Performance Gate
...
3. Targeted tests for affected modules under `docs/governance/REFERENCE-HARDWARE.md; docs/benchmarks; tests/OgmaLibrary.Tests/Catalogue; tests/OgmaLibrary.Tests/LanHost`. Choose the narrowest matching project/filter first and record the exact command.
...
Findings that may be marked resolved after this phase: **F-PERF-002, F-PERF-004**.
