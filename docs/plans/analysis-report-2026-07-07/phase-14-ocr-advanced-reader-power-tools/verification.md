# Phase 14 Verification: Localization and Copy Debt Closure
...
3. Targeted tests for affected modules under `src/OgmaLibrary.App/Views; src/OgmaLibrary.App/ViewModels; src/OgmaLibrary.App/Localization; tests/OgmaLibrary.Tests.Ui`. Choose the narrowest matching project/filter first and record the exact command.
...
Findings that may be marked resolved after this phase: **F-UI-002, F-DOC-002**.
