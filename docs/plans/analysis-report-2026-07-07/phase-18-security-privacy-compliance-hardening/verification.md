# Phase 18 Verification: Packaging and Installers
...
3. Targeted tests for affected modules under `build; scripts; .github/workflows; src/OgmaLibrary.App; docs/deployment`. Choose the narrowest matching project/filter first and record the exact command.
...
Findings that may be marked resolved after this phase: **F-REL-001, F-FUNC-002**.
