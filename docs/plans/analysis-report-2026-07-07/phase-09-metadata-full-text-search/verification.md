# Phase 09 Verification: Metadata, OCR, and Health Reliability
...
3. Targeted tests for affected modules under `src/OgmaLibrary.Infrastructure/Metadata; src/OgmaLibrary.Infrastructure/Search; src/OgmaLibrary.Infrastructure/Ocr; tests/OgmaLibrary.Tests/Metadata`. Choose the narrowest matching project/filter first and record the exact command.
...
Findings that may be marked resolved after this phase: **F-FUNC-001, F-PERF-004, F-DATA-003**.
