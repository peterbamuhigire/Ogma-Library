# Phase 04 Verification: Security Threat Model and SAST Baseline
...
3. Targeted tests for affected modules under `docs/security; docs/qa; .github/workflows; tests/OgmaLibrary.Tests/Security; tests/OgmaLibrary.Tests/LanHost`. Choose the narrowest matching project/filter first and record the exact command.
...
Findings that may be marked resolved after this phase: **F-SEC-001, F-SEC-004, F-SEC-005, F-ARCH-001**.
