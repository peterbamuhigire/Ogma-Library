...
| AC05-3 | Targeted tests for `src/OgmaLibrary.Workers; src/OgmaLibrary.Reader; src/OgmaLibrary.Infrastructure/Assets; tests/OgmaLibrary.Tests/Security` pass. | Exact `dotnet test` or script command output. |
