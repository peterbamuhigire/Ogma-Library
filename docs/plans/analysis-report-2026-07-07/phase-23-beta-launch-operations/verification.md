# Phase 23 Verification: Beta Soak and Operational Drills
...
3. Targeted tests for affected modules under `docs/operations; docs/deployment; docs/qa; release feed artifacts`. Choose the narrowest matching project/filter first and record the exact command.
...
Findings that may be marked resolved after this phase: **F-REL-004, F-FUNC-002, F-PERF-003**.
