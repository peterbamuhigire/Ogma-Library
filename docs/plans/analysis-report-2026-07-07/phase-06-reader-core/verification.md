# Phase 06 Verification: At-Rest Encryption and Secret Lifecycle
...
3. Targeted tests for affected modules under `src/OgmaLibrary.Infrastructure/Security; src/OgmaLibrary.Infrastructure/Catalogue; src/OgmaLibrary.Infrastructure/AI; docs/security`. Choose the narrowest matching project/filter first and record the exact command.
...
Findings that may be marked resolved after this phase: **F-SEC-002, F-SEC-003, F-SEC-005**.
