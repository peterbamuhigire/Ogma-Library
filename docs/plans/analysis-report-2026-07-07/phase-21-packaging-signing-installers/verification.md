# Phase 21 Verification: Cross-Platform Release Candidate QA
...
3. Targeted tests for affected modules under `docs/qa; docs/benchmarks; tests; release artifacts`. Choose the narrowest matching project/filter first and record the exact command.
...
Findings that may be marked resolved after this phase: **F-TEST-003, F-TEST-004, F-UI-004**.
