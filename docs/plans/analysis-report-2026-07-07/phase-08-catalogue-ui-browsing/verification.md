# Phase 08 Verification: Catalogue UX and Asset Completion
...
3. Targeted tests for affected modules under `src/OgmaLibrary.App/Views/Catalogue; src/OgmaLibrary.App/ViewModels/Catalogue; src/OgmaLibrary.App/Assets; localization resources`. Choose the narrowest matching project/filter first and record the exact command.
...
Findings that may be marked resolved after this phase: **F-FUNC-002, F-FUNC-004, F-UI-001, F-UI-002**.
