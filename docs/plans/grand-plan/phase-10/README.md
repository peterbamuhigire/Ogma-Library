...
| **Status** | WP1 complete locally; WP2 backend metadata search implemented locally; search UI debounce/results, extraction pipeline, FTS service, Index Manager, full benchmarks, UI/i18n/icons, G7, and manual closeout pending |
