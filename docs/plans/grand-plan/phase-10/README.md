...
| **Status** | WP1 complete locally; WP2 metadata/search UI implemented locally; WP3 core extraction pipeline implemented locally; WP4 FTS search implemented locally; WP5 Index Manager backend/UI implemented locally; WP6 keyboard/i18n/a11y foundations implemented locally; premium icons, pseudolocale/golden-corpus/manual accessibility signoff, and final closeout pending |
