...
| 2026-06-01 | WP7 UI/i18n foundation added: search panel exposes localized semantic availability text, localized confidence labels, and focusable match-location badges with accessible names | Codex |
