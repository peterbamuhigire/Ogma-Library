...
Phase 11 WP1, WP2 backend foundations, and WP3 semantic-search foundations have
started locally. The embedding schema has been aligned with the Phase 11 model/version requirements,
