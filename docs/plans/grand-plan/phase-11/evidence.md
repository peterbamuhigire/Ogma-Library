...
Phase 11 WP1, WP2 backend foundations, and the first WP3 cosine-similarity
slice have started locally. The embedding schema has been aligned with the Phase 11 model/version requirements,
...
- WP3: cosine similarity and deterministic top-K are implemented locally; semantic search service and P95 benchmark remain.
