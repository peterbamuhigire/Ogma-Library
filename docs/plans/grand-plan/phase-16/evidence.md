...
| `dotnet test tests\OgmaLibrary.Tests\OgmaLibrary.Tests.csproj --configuration Release --no-restore --logger "console;verbosity=minimal"` | Passed: 464 tests |
