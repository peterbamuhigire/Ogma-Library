...
namespace OgmaLibrary.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925132534_Sept23Phase17TextStatus")]
    partial class Sept23Phase17TextStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OgmaLibrary.Infrastructure.Catalogue.Entities.BookRow", b =>
                {
                    ...
                    b.HasIndex("TextStatus")
                        .HasDatabaseName("IX_Books_TextStatus");
            ...
            modelBuilder.Entity("OgmaLibrary.Infrastructure.Catalogue.Entities.EmbeddingIndexStateRow", b =>
                {
                    b.Property<string>("StateKey")
                        .HasMaxLength(32)
                        .HasColumnType("TEXT");

                    b.Property<string>("ActiveIndexVersion")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("TEXT");

                    b.Property<string>("StagingIndexVersion")
                        .HasMaxLength(128)
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("EmbeddingIndexState", null, t =>
                        {
                            t.HasCheckConstraint("CK_EmbeddingIndexState_ActiveVersion", "length(ActiveIndexVersion) BETWEEN 1 AND 128");

                            t.HasCheckConstraint("CK_EmbeddingIndexState_StagingVersion", "StagingIndexVersion IS NULL OR length(StagingIndexVersion) BETWEEN 1 AND 128");
                        });
                });
            ...
            modelBuilder.Entity("OgmaLibrary.Infrastructure.Catalogue.Entities.EmbeddingVectorRow", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("TombstonedUtc")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("IsTombstoned", "ModelName", "ModelVersion")
                        .HasDatabaseName("IX_EmbeddingVectors_Tombstone_Model");

                    b.HasIndex("ChunkId", "ModelName", "ModelVersion", "IndexVersion")
                        .IsUnique()
            ...
            modelBuilder.Entity("OgmaLibrary.Infrastructure.Catalogue.Entities.ExtractionIssueRow", b =>
                {
                    b.Property<long>("ExtractionIssueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("ExtractionIssueId");

                    b.HasIndex("BookId", "ContentHash", "PageIndex")
                        .IsUnique()
                        .HasDatabaseName("UX_ExtractionIssues_Book_Hash_Page");

                    b.ToTable("ExtractionIssues", null, t =>
                        {
                            t.HasCheckConstraint("CK_ExtractionIssues_Occurrences", "Occurrences >= 1");
                        });
                });
            ...
            modelBuilder.Entity("OgmaLibrary.Infrastructure.Catalogue.Entities.IdentityGroupChangeRow", b =>
                {
                    ...
                    b.ToTable("IdentityGroupChanges", (string)null);
                });
            ...
            modelBuilder.Entity("OgmaLibrary.Infrastructure.Catalogue.Entities.JobRow", b =>
                {
                    ...
                    b.Property<int?>("LeaseOwnerPid")
                        .HasColumnType("INTEGER");

                    b.Property<long?>("LeaseOwnerStartTicks")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("WaitingCapability")
                        .HasMaxLength(64)
                        .HasColumnType("TEXT");
